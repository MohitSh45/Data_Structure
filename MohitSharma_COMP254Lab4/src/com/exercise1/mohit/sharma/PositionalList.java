...
public interface PositionalList<E> extends Iterable<E> {
  ...
  default Position<E> findPosition(E e) {
	    for (Position<E> p : positions()) { // Use positions() to get all positions
	        if (p.getElement().equals(e)) { // Check if element matches
	            return p; // Return the first matching position
	        }
	    }
