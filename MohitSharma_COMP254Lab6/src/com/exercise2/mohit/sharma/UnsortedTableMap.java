...
public class UnsortedTableMap<K,V> extends AbstractMap<K,V> {
  ...
  public boolean containsKey(K key) {
    return findIndex(key) != -1;  // Returns true if key is found, false otherwise
  }
  ...
  public Iterable<Entry<K,V>> entrySet() { return new EntryIterable(); }
	    ...
	    public static void main(String[] args) {
	        ...
	        dataMap.put("lion", 80);
	        dataMap.put("tiger", 60);
	        dataMap.put("parrot", 20);

	        // Verify if keys exist
	        System.out.println("Does the key 'lion' exist? " + dataMap.containsKey("lion"));  // Expected: true
	        System.out.println("Does the key 'elephant' exist? " + dataMap.containsKey("elephant"));  // Expected: false

	        // Remove an entry and verify again
	        dataMap.remove("tiger");
	        System.out.println("Does 'tiger' exist post-removal? " + dataMap.containsKey("tiger"));  // Expected: false
	        System.out.println("Does 'parrot' exist post-removal? " + dataMap.containsKey("parrot"));  // Expected: true
	    }
	}
